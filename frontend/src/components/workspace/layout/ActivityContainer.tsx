...
import type { RailMode, ActivityConfiguration, ActivityContainerProps } from './types'
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="h-screen bg-background flex overflow-hidden">
        {/* Left Rail - Controls activity/mode */}
        <LeftRail 
          activeMode={railMode}
...
export type { ActivityConfiguration, ActivityContainerProps } from './types'